...
**关联**: [[wiki/grace/kmd/arch/layered-architecture]] | [[wiki/grace/kmd/env|环境与构建]]
...
[[wiki/grace/kmd/arch/layered-architecture|三层架构]]要求 kmdlib 不直接调内核。`os_interface.c` 就是那条缝隙：
...
- [[wiki/grace/kmd/arch/layered-architecture]]：缝隙在三层架构里的位置。
- [[wiki/grace/kmd/env|环境与构建]]：构建命令与编译开关。
