...
**关联**: [[aigc_ctx]] | [[aigc_vm]] | [[aigc_page_table]] | [[wiki/grace/kmd/memory/index|内存与页表]]
...
详细每一步对应哪个 ioctl/函数，见 [[wiki/grace/kmd/memory/index|内存与页表]]。注意「描述符 `mem_handle`」和
...
- [[wiki/grace/kmd/memory/index|内存与页表]]：堆、NUMA/UMA、DSMEM、生命周期细节。
