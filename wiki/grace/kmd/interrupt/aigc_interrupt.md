...
**关联**: [[wiki/grace/kmd/interrupt/index|中断与 Fence]] | [[aigc_kmd_fence]]
...
- [[wiki/grace/kmd/interrupt/index|中断与 Fence]]：事件环全景。
- [[aigc_kmd_fence]]：向量 40 + 时间戳怎么释放等待者。
- [[wiki/grace/kmd/queue/aigc_sched]]：进度中断怎么唤醒调度 kthread。
