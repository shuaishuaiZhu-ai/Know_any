...
> 图解源文件：[`01-panorama.dot`](../../../_attachments/grace/kmd/diagrams/01-panorama.dot)（Graphviz DOT，可重渲染）。
...
> 图解源文件：[`02-layers.dot`](../../../_attachments/grace/kmd/diagrams/02-layers.dot)。详见 [01 整体架构](<./01-architecture.md>)。
