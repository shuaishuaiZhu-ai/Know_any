...
related:
  - "[[wiki/grace/mas/RguCore/00-system-overview|00 系统总览]]"
  - "[[wiki/grace/mas/RguCore/05-control-data-flow|05 控制流与数据流]]"
  - "[[wiki/grace/mas/RguCore/07-glossary-qa-index|07 术语与问答索引]]"
---
...
- [[wiki/grace/mas/RguCore/00-system-overview|00 系统总览]]：理解 RGU 在系统中的总体位置。
- [[wiki/grace/mas/RguCore/01-rgu-core|01 RguCore 执行核心]]：理解 block 最终进入 core 后发生什么。
- [[wiki/grace/mas/RguCore/05-control-data-flow|05 控制流与数据流]]：把 CP、GCtrl、Router、Core 的控制路径串起来。
- [[wiki/grace/mas/RguCore/07-glossary-qa-index|07 术语与问答索引]]：补齐术语。
