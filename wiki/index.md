...
| 互联 | [FW Interconnect 索引](<./grace/fw/interconnect/index.md>) | C2C、AXI5、OISA、PCIe/HWJ 对比、topo discovery、AMT route、[portmap 路由表](<./grace/fw/interconnect/portmap-routing-table.md>)、[近端/远端环回](<./grace/fw/interconnect/c2c-loopback-near-far.md>)、loopback/RAS。 |
