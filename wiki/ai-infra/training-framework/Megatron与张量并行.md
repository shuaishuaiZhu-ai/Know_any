...
![张量并行原理：列切与行切 lark-whiteboard 图解](../../../_attachments/ai-infra/training-framework/Megatron与张量并行/whiteboard-mermaid/01-张量并行原理-列切与行切-flowchart.png)

> 图解源文件：[`01-张量并行原理-列切与行切-flowchart.mmd`](../../../_attachments/ai-infra/training-framework/Megatron与张量并行/whiteboard-mermaid/01-张量并行原理-列切与行切-flowchart.mmd)。
...
![4+1 架构：六种并行策略 lark-whiteboard 图解](../../../_attachments/ai-infra/training-framework/Megatron与张量并行/whiteboard-mermaid/02-4+1-架构-六种并行策略-flowchart.png)

> 图解源文件：[`02-4+1-架构-六种并行策略-flowchart.mmd`](../../../_attachments/ai-infra/training-framework/Megatron与张量并行/whiteboard-mermaid/02-4+1-架构-六种并行策略-flowchart.mmd)。
