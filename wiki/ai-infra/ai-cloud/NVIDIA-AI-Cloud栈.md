...
![七层栈（L1–L7）+ 两条侧链 lark-whiteboard 图解](../../../_attachments/ai-infra/ai-cloud/NVIDIA-AI-Cloud栈/whiteboard-mermaid/01-七层栈（L1–L7）+-两条侧链-flowchart.png)

> 图解源文件：[`01-七层栈（L1–L7）+-两条侧链-flowchart.mmd`](../../../_attachments/ai-infra/ai-cloud/NVIDIA-AI-Cloud栈/whiteboard-mermaid/01-七层栈（L1–L7）+-两条侧链-flowchart.mmd)。
