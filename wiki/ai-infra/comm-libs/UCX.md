...
![四层架构 lark-whiteboard 图解](../../../_attachments/ai-infra/comm-libs/UCX/whiteboard-mermaid/01-四层架构-flowchart.png)

> 图解源文件：[`01-四层架构-flowchart.mmd`](../../../_attachments/ai-infra/comm-libs/UCX/whiteboard-mermaid/01-四层架构-flowchart.mmd)。
...
![关键机制 lark-whiteboard 图解](../../../_attachments/ai-infra/comm-libs/UCX/whiteboard-mermaid/02-关键机制-sequencediagram.png)

> 图解源文件：[`02-关键机制-sequencediagram.mmd`](../../../_attachments/ai-infra/comm-libs/UCX/whiteboard-mermaid/02-关键机制-sequencediagram.mmd)。
