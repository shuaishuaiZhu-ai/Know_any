...
![性能优化总诀：三方向 lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/01-性能优化总诀-三方向-flowchart.png)

> 图解源文件：[`01-性能优化总诀-三方向-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/01-性能优化总诀-三方向-flowchart.mmd)。
...
![系统平衡之美：FPS 稳如直线 lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/02-系统平衡之美-FPS-稳如直线-flowchart.png)

> 图解源文件：[`02-系统平衡之美-FPS-稳如直线-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/02-系统平衡之美-FPS-稳如直线-flowchart.mmd)。
...
![关键技术 lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/03-关键技术-flowchart.png)

> 图解源文件：[`03-关键技术-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/03-关键技术-flowchart.mmd)。
...
![数据 IO 优化 lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/04-数据-IO-优化-flowchart.png)

> 图解源文件：[`04-数据-IO-优化-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/04-数据-IO-优化-flowchart.mmd)。
...
![训练框架优化：梯度融合 lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/05-训练框架优化-梯度融合-flowchart.png)

> 图解源文件：[`05-训练框架优化-梯度融合-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/05-训练框架优化-梯度融合-flowchart.mmd)。
...
![模型优化：Roofline 与 MFU lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/06-模型优化-Roofline-与-MFU-flowchart.png)

> 图解源文件：[`06-模型优化-Roofline-与-MFU-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/06-模型优化-Roofline-与-MFU-flowchart.mmd)。
...
![性能诊断决策树 lark-whiteboard 图解](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/07-性能诊断决策树-flowchart.png)

> 图解源文件：[`07-性能诊断决策树-flowchart.mmd`](../../../_attachments/ai-infra/debug-tools/千卡训练性能优化/whiteboard-mermaid/07-性能诊断决策树-flowchart.mmd)。
