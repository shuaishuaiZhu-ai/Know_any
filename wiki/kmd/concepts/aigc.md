...
**关联**: [[aigc_lib_device]] | [[wiki/kmd/arch/layered-architecture]] | [[wiki/kmd/concepts/index|核心数据结构]]
...
[[wiki/kmd/arch/layered-architecture|三层架构]]在数据结构上的落地：换内核版本主要动 OS 侧，换芯片主要动核心/HAL，
两者互不污染。
