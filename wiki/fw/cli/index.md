...
- [CP USART 移到 IMC 统一初始化：代码修改和原因](<./cp-usart-imc-unified-init.md>)：解释 `zss/MoveUsart` 当前代码如何把 CP USART 硬件初始化迁到 IMC，CP 侧为何只注册 RT-Thread device/console/shell，并包含关键图解。
...
- CP USART 移到 IMC 统一初始化：[CP USART 移到 IMC 统一初始化：代码修改和原因](<./cp-usart-imc-unified-init.md>)
