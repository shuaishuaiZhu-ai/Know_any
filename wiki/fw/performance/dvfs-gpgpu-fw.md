...
related:
  - "[[wiki/fw/performance/index|FW 性能索引]]"
  - "[[wiki/fw/concepts/index|FW 概念索引]]"
  - "[[wiki/fw/imc/startup-to-main|IMC 启动到 main 流程]]"
  - "[[wiki/mas/RguCore/02-rgu-gctrl|RguGCtrl 学习文档]]"
---
...
- [[wiki/fw/performance/index|FW 性能索引]]：继续看 FW 性能和 hot path。
- [[wiki/fw/imc/startup-to-main|IMC 启动到 main 流程]]：理解 clock/reset/board init 在 FW 启动阶段的位置。
- [[wiki/mas/RguCore/02-rgu-gctrl|RguGCtrl 学习文档]]：理解 GPGPU 任务如何从 kernel 分发到 cluster/core，帮助把 workload 和 DVFS 联系起来。
