...
4. Read `wiki/ai/index.md` when the task involves AI tools, solved bugs, workflows, reflections, templates, or server passwords.
5. Read `wiki/hot.md` for recent active context.
6. For chip-stack topics, enter through `wiki/grace/index.md`, then the nearest domain index such as `wiki/grace/fw/index.md` or `wiki/grace/kmd/index.md`.
7. Use `wiki/sources/` only for evidence checks after reading the authored wiki page.
